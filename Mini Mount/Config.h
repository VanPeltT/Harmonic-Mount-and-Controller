...
// Slewing Speed: 1.5 degrees/second (estimated)
// Generated on: 2022-07-13 21:17
// ---------------------------------------------------------------------------------------------------------------------------------
...
#define PINMAP                        MiniPCB2 //    OFF, Choose from: MiniPCB, MiniPCB2, MaxPCB, MaxPCB2, STM32Blue,             <-Req'd
...
#define AXIS1_STEPS_PER_DEGREE    800 //  12800, n. Number of steps per degree:                                          <-Req'd
...
#define AXIS2_STEPS_PER_DEGREE    800 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
